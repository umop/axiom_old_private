...
define(
  "shell/views/terminal",
  ["axiom/core/error", "axiom/fs/path", "hterm/public", "exports"],
  function(axiom$core$error$$, axiom$fs$path$$, hterm$public$$, __exports__) {
    "use strict";
    ...
    __es6_export__("TerminalView", TerminalView);
    __es6_export__("default", TerminalView);
