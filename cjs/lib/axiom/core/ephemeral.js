...
"use strict";
var axiom$core$error$$ = require("axiom/core/error"), axiom$core$event$$ = require("axiom/core/event"), axiom$core$completer$$ = require("axiom/core/completer");
var Ephemeral = function() {
  /** @private @type {!Completer<T>} */
  this.ephemeralCompleter_ = new axiom$core$completer$$.default();
  ...
  this.onReady = new axiom$core$event$$.default();

  /** @const @type {!AxiomEvent} */
  this.onReset = new axiom$core$event$$.default();

  /** @const @type {!AxiomEvent} */
  this.onError = new axiom$core$event$$.default();

  /** @const @type {!AxiomEvent} */
  this.onClose = new axiom$core$event$$.default();
...
Ephemeral.prototype.assertReady = function() {
  if (this.readyState != Ephemeral.State.Ready)
    throw new axiom$core$error$$.default.Ephemeral('READY', this.readyState);
};
...
Ephemeral.prototype.assertEphemeral = function(var_args) {
  if (!this.isEphemeral.apply(this, arguments)) {
    throw new axiom$core$error$$.default.Ephemeral(Array.prototype.slice.call(arguments),
                                   this.readyState);
  }
};
...
Ephemeral.prototype.dependsOn = function(otherEphemeral) {
  otherEphemeral.onClose.addListener(
    function() {
      ...
      this.closeError(new axiom$core$error$$.default.ParentClosed(otherEphemeral.closeReason,
...
Ephemeral.prototype.closeError = function(value) {
  ...
  if (!(value instanceof axiom$core$error$$.default)) {
    ...
    value = new axiom$core$error$$.default.Unknown(value);
  }
