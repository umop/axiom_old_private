...
"use strict";
var axiom$fs$path$$ = require("axiom/fs/path"), axiom$fs$stat_result$$ = require("axiom/fs/stat_result");
...
var JsEntry = function(jsfs, modeStr) {
  this.jsfs = jsfs;
  this.mode = axiom$fs$path$$.default.modeStringToInt(modeStr);
};

exports["default"] = JsEntry;
...
JsEntry.prototype.hasMode = function(modeStr) {
  return (this.mode & axiom$fs$path$$.default.modeStringToInt(modeStr));
};
...
JsEntry.prototype.stat = function() {
  return Promise.resolve(new axiom$fs$stat_result$$.default(this.mode));
};
