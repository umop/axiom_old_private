...
"use strict";
var axiom$core$error$$ = require("axiom/core/error"), axiom$core$ephemeral$$ = require("axiom/core/ephemeral"), axiom$fs$base$open_context$$ = require("axiom/fs/base/open_context"), axiom$fs$path$$ = require("axiom/fs/path"), axiom$fs$seek_whence$$ = require("axiom/fs/seek_whence"), axiom$fs$data_type$$ = require("axiom/fs/data_type");
...
var abstract = function() { throw new axiom$core$error$$.default.AbstractCall() };
...
FileSystem.prototype = Object.create(axiom$core$ephemeral$$.default.prototype);
...
FileSystem.prototype.readFile = function(
  ...
  var whence = opt_whence || axiom$fs$seek_whence$$.default.Begin;
