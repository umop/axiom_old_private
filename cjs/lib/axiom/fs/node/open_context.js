...
"use strict";
var axiom$core$error$$ = require("axiom/core/error"), axiom$fs$base$open_context$$ = require("axiom/fs/base/open_context"), axiom$fs$node$nodefs_util$$ = require("axiom/fs/node/nodefs_util"), axiom$fs$path$$ = require("axiom/fs/path");
...
var NodeOpenContext = function(nodefs, path, arg) {
  ...
  this.onFileError_ = axiom$fs$node$nodefs_util$$.default.rejectFileError.bind(null, path.spec);
...
exports["default"] = NodeOpenContext;
...
exports.NodeOpenContext = NodeOpenContext;
