...
"use strict";
var axiom$core$error$$ = require("axiom/core/error"), wash$termcap$$ = require("wash/termcap");
...
var main = function(executeContext) {
  ...
  if (inputHistory && !(inputHistory instanceof Array))
    return Promise.reject(new axiom$core$error$$.default.Invalid('inputHistory', inputHistory));

  if (!executeContext.getTTY().isatty)
    return executeContext.closeError(new axiom$core$error$$.default.Runtime('Not a tty'));

  var readline = new Readline(executeContext);
  executeContext.ready();

  return readline.read(inputHistory);
};
...
exports.Readline = Readline, exports.main = main;
